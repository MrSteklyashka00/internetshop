<h1>Корзина</h1>
<div class="basket_type_container">
    <div  id="basket_type_cur"class="basket_type basket_selected">Текущая </div>
    <div id=""basket_type_old class="basket_type">Завершенные</div>
</div>

<div class="basket_cards_container">

<div class="basket_card_item">
    <div class="basket_card_image_wraper">
        <div class="basket_card_image"></div>
    </div>
